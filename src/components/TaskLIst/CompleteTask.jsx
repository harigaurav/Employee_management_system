...
const CompleteTask = ({Data}) => {
  return (
   <div className=' flex-shrink-0 h-full w-[300px] bg-purple-500 rounded-xl p-5'>
        ...
        <p className='text-white mt-4 text-sm'>
          ...
          <div className='flex justify-center mt-4'>
            <button className='bg-green-500 text-white p-2 rounded text-sm active:scale-90 w-full' >Complete</button>
        </div>
      </div>
  )
}
