  ...
  return (
    <div className=' flex-shrink-0 h-full w-[300px] bg-yellow-500 rounded-xl p-5'>
        ...
        <div className='flex justify-between mt-4'>
            <button className='bg-green-500 text-white p-2 rounded text-sm active:scale-90' >Mark as Completed</button>
            <button className='bg-red-500 text-white p-2 rounded text-sm active:scale-90'>Mark as Failed</button>
        </div>
      </div>
  )
}
